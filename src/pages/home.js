                        ...
                        <div className="container marketing">
                            ...
                            <div className="row">
                                <div className="col-lg-4">
                                    ...
                                    <h3 className="fw-normal features text-black">Fast Conversion</h3>
                                    <p>
                                        Get your converted text as fast as possible, you just have to upload the documents.
                                    </p>
                                </div>
                                {/* /.col-lg-4 */}
                                <div className="col-lg-4">
                                    ...
                                    <h3 className="fw-normal features text-black">Diffrent Formats</h3>
                                    <p>
                                        Download covnerted text into diffrent files in formats as per your requirments.
                                    </p>
                                </div>
                                {/* /.col-lg-4 */}
                                <div className="col-lg-4">
                                    ...
                                    <h3 className="fw-normal features text-black">Direct Clipboard</h3>
                                    <p>
                                        Get converted text directly into your clipboard to use wherever you want.
                                    </p>
                                </div>
                                {/* /.col-lg-4 */}
                            </div>
                            ...
                            <div className="row featurette">
                                <div className="col-md-7">
                                    <h2 className="featurette-heading fw-normal lh-1 text-black">
                                        Save Your Fingers
                                        <span className="text-muted"> With Typing </span>
                                    </h2>
                                    <p className="lead">
                            ...
                            <div className="row featurette">
                                <div className="col-md-7 order-md-2">
                                    <h2 className="featurette-heading fw-normal lh-1 text-black">
                                        Documents Will Be
                                        <span className="text-muted">Text Searchable</span>
                                    </h2>
                                    <p className="lead">
                                ...
                                <div className="col-md-5 order-md-1">
                                    <img className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" src="./assets/assets/img5.jpg" width={500} height={500} alt />
                                </div>
                            </div>
                            <hr className="featurette-divider" />
                            <div className="row featurette">
                                <div className="col-md-7">
                                    <h2 className="featurette-heading fw-normal lh-1 text-black">
                                        Empower Your Business<span className="text-muted"> With OCR</span>
                                    </h2>
                                    <p className="lead">
                                ...
                                <div className="col-md-5">
                                    <img className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" src="./assets/assets/img6.jpg" width={500} height={500} alt />
                                </div>
                            </div>
                            <hr className="featurette-divider" />
                            {/* /END THE FEATURETTES */}
